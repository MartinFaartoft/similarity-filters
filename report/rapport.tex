...
Note that the VS is a standard Bloom filter, and is prone to false positives itself. That means it only serves to minimized false positives, and not outright remove them.
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{FPR1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{FNR1}
\end{subfigure}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{FPR2}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{FNR2}
\end{subfigure}
