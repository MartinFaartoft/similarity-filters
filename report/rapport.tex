...
%Copy paste fra Pagh, men jeg synes det spiller godt.
...
%   Begræns problemet
In this report we focus on the special case of similarity search were the elements in the set $S$ is bit-vectors. Futhermore we choose the 'closeness' metric to be the Hamming-distance.
