...
This shows that $\epsilon$ has to be kept below $\frac{1}{l'}$ if $t$ should stay positive, and increasing $k$, surprisingly, does nothing change this. This way of eliminating false negatives may be useful in practice, if $\epsilon$ is extremely small, but the usefulness drops of rapidly with increasing $\epsilon$, as the false positive rate goes towards 1.
